...
public class ProgressWheel extends View{
     ...
     * @param context
     */
    public ProgressWheel(Context context) { super(context); }
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        } else { circleBounds = new RectF(paddingLeft + barWidth, paddingTop + barWidth, layout_width - paddingRight - barWidth, layout_height - paddingBottom - barWidth); }
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        reversed = a.getBoolean(R.styleable.ProgressWheel_matProg_reversed, false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(isSpinning) {
            ...
            if(oldProgress != mProgress)runCallback();
    ...
    private void updateBarLength(long deltaTimeInMilliSeconds) {
        ...
        } else { pausedTimeWithoutGrowing += deltaTimeInMilliSeconds; }
    }

    public boolean isLinearProgress(){
     ...
     */
    public float getProgress() { return isSpinning ? -1 : mProgress / 360.0f; }
     ...
     */
    public float getSpinSpeed() { return spinSpeed / 360.0f; }
     ...
     */
    public void setSpinSpeed(float spinSpeed) { this.spinSpeed = spinSpeed * 360.0f; }

    /**
     * @return the width of the wheel's contour in pixels
     */
    public int getRimWidth() { return rimWidth; }
    ...
    static class WheelSavedState extends BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte((byte) (reversed ? 1 : 0));
        }
        ...
        public static final Creator<WheelSavedState> CREATOR = new Creator<WheelSavedState>() {
            ...
            public WheelSavedState[] newArray(int size) { return new WheelSavedState[size]; }
        };
    }
